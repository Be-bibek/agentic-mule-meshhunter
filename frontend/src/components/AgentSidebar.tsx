      ...
      <div className="sidebar-content">
        <AnimatePresence>
          {logs.map((log, i) => {
            ...
            if (log.type === 'investigation_started') entryClass += " started";
            else if (log.action) entryClass += " action";
            else if (log.type === 'investigation_complete') entryClass = ""; // Handled by verdict-box
                ...
                {log.type === 'investigation_started' ? (
                  <>
                    <div className="log-header">
                      ...
                      <div className="log-title" style={{ color: 'var(--accent-cyan)' }}>Agent Dispatched</div>
                    </div>
